...
namespace PlatformService {
  public static partial class GrpcPlatfom
  {
    static readonly string __ServiceName = "GrpcPlatfom";
    ...
    /// <summary>Client for GrpcPlatfom</summary>
    public partial class GrpcPlatfomClient : grpc::ClientBase<GrpcPlatfomClient>
    {
      /// <summary>Creates a new client for GrpcPlatfom</summary>
      /// <param name="channel">The channel to use to make remote calls.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public GrpcPlatfomClient(grpc::ChannelBase channel) : base(channel)
      {
      }
      /// <summary>Creates a new client for GrpcPlatfom that uses a custom <c>CallInvoker</c>.</summary>
      /// <param name="callInvoker">The callInvoker to use to make remote calls.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public GrpcPlatfomClient(grpc::CallInvoker callInvoker) : base(callInvoker)
      {
      }
      /// <summary>Protected parameterless constructor to allow creation of test doubles.</summary>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected GrpcPlatfomClient() : base()
      {
      }
      /// <summary>Protected constructor to allow creation of configured clients.</summary>
      /// <param name="configuration">The client configuration.</param>
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected GrpcPlatfomClient(ClientBaseConfiguration configuration) : base(configuration)
      {
      }
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      protected override GrpcPlatfomClient NewInstance(ClientBaseConfiguration configuration)
      {
        return new GrpcPlatfomClient(configuration);
      }
    }

...
namespace PlatformService {
  public static partial class GrpcPlatfom
  {
    ...
    /// <summary>Base class for server-side implementations of GrpcPlatfom</summary>
    [grpc::BindServiceMethod(typeof(GrpcPlatfom), "BindService")]
    public abstract partial class GrpcPlatfomBase
    {
    ...
    public static grpc::ServerServiceDefinition BindService(GrpcPlatfomBase serviceImpl)
    {
    ...
    /// <param name="serviceImpl">An object implementing the server-side handling logic.</param>
    public static void BindService(grpc::ServiceBinderBase serviceBinder, GrpcPlatfomBase serviceImpl)
    {
